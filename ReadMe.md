...
- Mapper Key: By default, rando saves have Iselda always be available. Turns out, Cornifer may or not have lost the shop key. This will add a location somewhere close to Crossroads Cornifer and an item that will trigger accesibility to the shop's door in Dirtmouth.
...
## Shade Gates
This setting makes each of the 8 existing Shade Gates a randomizable object rather than blocking your path until you get Shade Cloak. The way this works is, whenever you get a Shade Gate item, you can just walk through the gates (or dash normally through them). Whenever you Shade Dash against a Shade Gate, an item will be granted instead.
